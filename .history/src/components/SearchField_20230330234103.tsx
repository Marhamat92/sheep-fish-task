...
import { getAllCategories, reset } from "../features/productsSlice";
...
const SearchField = ({}: Props) => {
  ...
  const { products, isLoading, isError, message, isSuccess, categories } =
    useSelector((state: any) => state.products.categories || {});
  ...
  return (
    <form className=''>
      <div className='flex'>
        ...
        <div
          id='dropdown'
          className='z-10 fixed hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700'
        >
          <ul
